$(document).ready(function () {
    ...
    pantallap (anchoPantalla,listadoTarjetas);
    ...
    pantallap(anchoPantalla,cambioimg) 
    });

    
});
    function pantallap(anchoPantalla,listadoTarjetas){
        ...
        if (anchoPantalla < 920) {
            ...
            $('main').removeClass('fondoa')
            $('main').addClass('fondob')
            ...
            for(let i=0; i < listadoTarjetas.length; i++){
                ...
                var imgcss = i+1;
                $('.miTarjeta:nth-child('+ imgcss + ') img').attr('src',imagenIni);
            }
        } else{
            ...
            $('main').removeClass('fondob')
            $('main').addClass('fondoa')
